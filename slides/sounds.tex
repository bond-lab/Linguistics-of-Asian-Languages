...
% ======================================================
\section{What the chapter covers}
...
% ======================================================
\section{Insular Southeast Asia (Austronesian)}
...
% illustration: table with Malay orthography vs IPA
\end{itemize}
\end{frame}
...
% illustration: waveform/spectrogram of [k] vs [ʔ]
\end{itemize}
\end{frame}
...
% illustration: vowel chart overlay (Tagalog vs. Malay)
\end{itemize}
\end{frame}
...
% illustration: Acehnese vowel trapezoid
\end{itemize}
\end{frame}
...
% illustration: dialectal maps of Peninsular Malay finals
\end{itemize}
\end{frame}
...
% ======================================================
\section{Mainland Southeast Asia}
...
% illustration: Thai script–IPA–romanization alignment
\end{itemize}
\end{frame}
...
\end{tabular}
\begin{itemize}
\item $\sim$9 vowels; length contrasts important \booksrc{5.1.2}
...
% illustration: Thai vowel chart with length marks
\end{itemize}
\end{frame}

\begin{frame}{Vietnamese Overview}
\begin{itemize}
\item $\sim$23 consonants; 12 vowels \booksrc{5.1.2}
...
\begin{itemize}
\item $\sim$34 consonants (3 marginal) \booksrc{5.1.2}
...
% illustration: feature inventory heatmap
\end{itemize}
\end{frame}
...
% illustration: Khmer register → length diachrony
\end{itemize}
\end{frame}
...
% illustration: Mandarin initial–final chart
\end{itemize}
\end{frame}
...
% illustration: Cantonese level vs. checked tone contours
\end{itemize}
\end{frame}
...
\item Neutralization and allophony (e.g., /r/ $\sim$ [l]/[r]) \booksrc{5.1.3}
...
\end{tabular}
\begin{itemize}
\item $\sim$8 simple vowels (front rounded often diphthongs) \booksrc{5.1.3}
...
% illustration: devoicing spectrogram (ki̥tsɯ)
\end{itemize}
\end{frame}
...
% illustration: mora timing diagram
\end{itemize}
\end{frame}
...
% ======================================================
\section{Phonotactics (Comparative)}
...
% illustration: Initials × Finals grid
\end{itemize}
\end{frame}
...
% illustration: Vietnamese vowel sequences with allowable codas
\end{itemize}
\end{frame}
...
% illustration: loanword adaptation flow (EN→JA)
\end{itemize}
\end{frame}
...
% illustration: Thai pitch tracks by syllable type
\end{itemize}
\end{frame}
...
% illustration: stepwise tone sandhi schematics
\end{itemize}
\end{frame}
...
\begin{itemize}
\item $\sim$1/3 of world’s languages have tone \booksrc{5.3.4}
...
% illustration: table of N- allomorphs by following C
\end{itemize}
\end{frame}
...
\item N assimilation; word-final N $\sim$ uvular nasal in careful speech \booksrc{5.2.2}
% illustration: kana mapping of Q/N sequences
\end{itemize}
\end{frame}
...
% ======================================================
\section{Pitch-Accent in Japanese}
...
% illustration: HL/LH curves over multi-syllabic words
\end{itemize}
\end{frame}
...
% illustration: step graph of L/H sequences by accent site
\end{itemize}
\end{frame}
