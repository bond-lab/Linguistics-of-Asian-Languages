...
\textbf{Takeaway:} Apart from the USA, there are more English speakers in India than in any ``Inner Circle'' country --- and all but 0.3 million of them speak it as a second language.}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Unique words like \eng[to reschedule earlier]{prepone} and \eng[warehouse]{godown}.
    \end{itemize}
    \item \textbf{Grammar:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \eng[to graduate]{pass out}
        \item \eng[not in town]{out of station}
    \end{itemize}
    \item \textbf{Local adaptations:}
    \begin{itemize}
        \item \eng[mountain resort]{hill station}
        \item \eng[leisure activity]{timepass}
        \item \eng[reply]{revert} (also used in Manglish/Singlish)
    \end{itemize}
\end{itemize}
\end{frame}
...
\item \lex{Kiasu:} \eng[fear of missing out]{He is so kiasu.}
\item \lex{Shiok:} \eng[delicious or enjoyable]{This food is so shiok!}
\item \lex{Blur:} \eng[confused or clueless]{Why are you so blur?}
\item \lex{Paiseh:} \eng[embarrassed]{So paiseh to ask!}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \eng[He has already gone.]{He go already.}
    \end{itemize}
    ...
    \begin{itemize}
    \item \eng[I am going to the market.]{I go market.}
    \item \eng[I will buy three books.]{I buy 3 book.}
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{Grammar:}
    \begin{itemize}
        \item Omission of articles and prepositions: \eng[I am going to the market]{I go market}.
    \end{itemize}
    \item \textbf{Vocabulary:}
    \begin{itemize}
        \item Loanwords from Cantonese: \eng[drink tea]{yum cha} and \eng[roast pork]{char siu}.
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \eng[He is very smart, you know.]{He very smart, la.}
    \end{itemize}
    \item \textbf{Different grammatical elements:}
    \begin{itemize}
        \item \eng[I do not understand.]{I no understand.}
    \end{itemize}
    \item \textbf{Unique phrases:}
    \begin{itemize}
        \item \eng[I am going to have dim sum with my family tomorrow.]{I go yum cha with family tomorrow.}
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \textbf{Creative coinages:}
      ...
      \item \lex{seku-hara}  ``sexual harassment''
        \item \lex{pawa-hara} (power harassment) ``workplace bullying''
        \item \lex{konbini}  ``convenience store''
        \item \lex{sukinshippu} (skinship) ``physical closeness or bonding''
        \item \lex{ha-to furu} (heartful) ``warm-hearted, caring''
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \textbf{British regional dialects} (Scouse, Geordie, Glaswegian)  
    Local prestige but low institutional prestige; hard for outsiders to understand.
