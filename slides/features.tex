...
%     \item Example: Mandarin \textit{gè}, Cantonese \textit{go}, Vietnamese \textit{cái}.
...
\begin{exe}
\ex
\gll Kéuih jouh-\ul{hōi} jūngdı́m ge. \\
    she work-hab part.time prt \\
\trans ‘She normally works part-time.’ \\
\end{exe}
\begin{exe}
\ex
\gll Kéuih yı́hchı̀hn jā-\ul{hōi} Bēnsı́ ge. \\
