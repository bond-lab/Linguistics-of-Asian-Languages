...
\begin{frame}{Foreign Loans in Contemporary Japanese}
    \begin{itemize}
        ...
        \item Hybrid words are common, e.g., \jpn{ichigo-ēdo} (strawberry + "ade") and \jpn{wan-man-kaa} (one-man car).
...
\begin{frame}{Compounding in Mandarin Chinese}
    \begin{itemize}
        ...
        \item Some compounds are parallel, where neither element modifies the other, e.g., \cmn{huā-mù} (flower-tree) meaning "vegetation".
        \item Metaphorical compounds are also common, e.g., \cmn{gǒu-xióng} (dog-bear) meaning "bear".
        \item Compound verbs can express a combination of similar or related actions, e.g., \cmn{tòng-kǔ} (painful-bitter) meaning "bitter and painful".
...
\begin{frame}{Derivational Affixation in Sinitic Languages}
    \begin{itemize}
        ...
        \item Prefixes and suffixes can form nouns from other words, e.g., \yue{góng-faat} (speak-way).
...
\begin{frame}{Derivational Affixation in Mainland Southeast Asia}
    \begin{itemize}
        ...
        \item Thai prefix \tha{kaan-} forms abstract nouns, e.g., \tha{kaan-lên} (playing).
...
\begin{frame}{Existence and Possession: A Common Polysemy}
    \begin{itemize}
        ...
        \item Malay \mtciteform{ada} and Mandarin \mtciteform{yǒu} mean both ``there is" and ``have"
...
\begin{frame}{Different Meanings for Actions}
    \begin{itemize}
        ...
        \item Cantonese uses specific verbs based on how something breaks, e.g., \mtciteform{dá laahn} ("smash into pieces").
...
% Slide 9
\begin{frame}{Key Words in Chinese: 孝 \mtciteform{xiào}}
    \begin{itemize}
        \item \mtciteform{Xiào} represents filial piety or devotion to one's parents.
        \item It emphasizes duty, respect, and caring for parents in old age.
        \item Fixed phrases: \mtciteform{"bǎi shàn xiào wéi xiān"} ("Of the hundred good deeds, \mtciteform{xiào} comes first").
        \item \mtciteform{Xiào} involves remembering and honoring parents and ancestors.
        \item Example: \mtciteform{"Fùmǔ eng bı́ shān gāo, bı́ hǎi shēn"} ("What our parents give us is higher than a mountain, deeper than the ocean").
    \end{itemize}
\end{frame}

% Slide 10
\begin{frame}{Semantic Explication of 孝 \mtciteform{xiào}}
    \begin{itemize}
...
\begin{frame}{Key Words in Chinese: 忍 \mtciteform{rěn}}
    \begin{itemize}
        \item \mtciteform{Rěn} means perseverance or patience, often in difficult situations.
...
% Slide 12
\begin{frame}{Semantic Explication of  忍 \mtciteform{rěn}}
    \begin{itemize}
...
\item it is good if a person can be like this     
        \end{itemize}
\bigskip
        \mtciteform{Rěn} embodies the importance of endurance and resilience.
