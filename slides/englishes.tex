...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{New words:} e.g., \eng{buttle}.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Rhotic: Pronouncing /r/ in words like \eng{car} and \eng{farm.}
        \item Flattened vowels: \eng{bat} may sound like "baet."
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item /r/ and /l/ sounds may overlap (e.g., \eng{rice} pronounced as \eng{lice}).
    \end{itemize}
    \item \textbf{Grammar:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Inserting vowels: \eng{table} becomes \eng{te-bu-ru.}
        \item No distinction between /l/ and /r/: \eng{light} and \eng{right} sound similar.
    \end{itemize}
    \item \textbf{Vocabulary:}
    \begin{itemize}
        \item Loanwords adapted to Japanese: \eng{salaryman} (businessman), \eng{OL} (office lady).
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \lex{Hand phone:} Mobile phone (from \eng{handy phone}).
        \item \lex{Viking:} Buffet (originating from \eng{smorgasbord}).
    \end{itemize}
    \item \textbf{Hybrid expressions:}
    \begin{itemize}
