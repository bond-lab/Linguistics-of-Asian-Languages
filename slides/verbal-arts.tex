...
\makeatother
% Define a robust version of eachwordone
\DeclareRobustCommand{\eachwordone}{\textcolor{teal}}
...
\begin{itemize}
    \item Proverbs are central to communication, especially in Malay.
    ...
    \item Culturally rich and expressive forms such as \textit{pantun} quatrains.
      \\ Pantun is a Malay poem with two parts, connected indirectly
...
\end{frame}
\begin{frame}
\frametitle{Examples of a Pantun}
\begin{exe}
  \ex \textcolor{teal}{Pisang emas bawa belayar, \\
      \hspace*{2em}Masak sebiji di atas peti; \\
      Hutang emas boleh dibayar, \\
      \hspace*{2em}Hutang budi dibawa mati.}

  \ex The golden plantain carried on a voyage;   \\
      \hspace*{2em}One ripens on top of the chest.   \\
      A debt of gold can be repaid;   \\
      \hspace*{2em}A debt of kindness lasts until death.
    \end{exe}

See \href{https://ir.uitm.edu.my/id/eprint/63499/1/63499.pdf}{\textit{Connecting the dots: The case of foreshadow and meaning in pantun}}
By Nazima Versay Kudus and Melati Desa (2022)
...
\begin{tabular}{lll}
    ...
    \hline
    hǔu-pàa-taa-thì & ear-forest-eye-forest & to be ignorant \\
...
\begin{frame}{Some Examples of Chengyu}
       ...
       \vspace{-3cm}
       \begin{exe}
         \DeclareRobustCommand{\eachwordone}{\chinesefontsf}
         \DeclareRobustCommand{\eachwordtwo}{\textcolor{teal}}
         \ex\label{s:rabbit}
         \glll 守 株 待 兔 \\
         shǒu zhū dài tù \\
         guard {tree stump} wait rabbit \\
         \trans Lit: waiting by a tree stump for a rabbit
...
\begin{frame}{Distribution of Chengyu in different Genres}
  ...
  We looked at how many chengyu could be found in translations from English to Chinese in four different genres.
  ...
  \begin{center}
      \begin{tabular}{lrrrr}
        ...
        \hline
        Story   &  1,226  &    79  &     90  & 7.3 \\
        News    &  2,138  &   108  &    161  & 7.5 \\
        Essay   &    816  &   103  &    127  & 15.6 \\
        Tourism &  3,280  &   187  &    388  & 11.8 \\
        \hline
        Total   &  7,460  &   427  &    766  & 10.3 \\
      \end{tabular}
    \end{center}
    \begin{itemize}
    \item The essay \textit{The Cathedral and the Bazaar} has the most,
...
\end{frame}
\begin{frame}{Auspicious and Inauspicious Words in Japanese}

\begin{tabular}{lll}
\multicolumn{3}{l}{\textbf{Auspicious Words ( \textjapanese{縁起の良いことば})}} \\
\hline
\textjapanese{松} (pine) & \textjapanese{まつ} & Longevity; evergreen resilience \\
\textjapanese{竹} (bamboo) & \textjapanese{たけ} & Strength, uprightness \\
\textjapanese{梅} (plum) & \textjapanese{うめ} & Renewal; the first flower of spring \\
\textjapanese{鯛} (sea bream) & \textjapanese{たい} & $\approx$ \textjapanese{めでたい}, “auspicious, happy” \\
\textjapanese{福} (fortune) & \textjapanese{ふく} & Good luck, prosperity  \\[1ex]

\multicolumn{3}{l}{\textbf{Inauspicious Words (\textjapanese{縁起の悪いことば})}} \\
\hline
\textjapanese{四} (four) & \textjapanese{し} &  $\approx$ \textjapanese{死} (death)\\
\textjapanese{櫛} (comb) & \textjapanese{く(し)} &  $\approx$ \textjapanese{苦} (suffering) \\
\textjapanese{切る} (to cut) & \textjapanese{きる} & Not at weddings: “to sever a relationship” \\
\textjapanese{別れる} (to part) & \textjapanese{わかれる} &  Not at weddings,  in gifts and speeches \\
\textjapanese{落ちる} (to fall) & \textjapanese{おちる} & Avoided around exams (implies “to fail”) \\
\hline
\end{tabular}

\medskip

So at weddings and New Year, we prefer \textjapanese{松竹梅} (pine, bamboo, plum) and avoid “cutting” or “separation” words or gifts of combs or knives!
\end{frame}
% Slide 1
\begin{frame}
...
‘What’ is \msa{apa} in ngoko, \msa{napa} in madya, \msa{punapa} in krama.
...
\begin{itemize}
    ...
    \item Example: \ko[polite]{haeyo-che} for general politeness.
    \item \ko[formal]{Hapsyo-che} for respectful or professional contexts.
\end{itemize}
\end{frame}
...
\begin{exe}
    \ex \gll \jpn{Chichi} \jpn{wa} \jpn{genkide} \jpn{ori-mas-u.} \\
        father topic healthy be:hum-pol-nonpast \\
        \trans ‘(My) father is healthy.’
    \ex \gll \jpn{O-too-san} \jpn{wa} \jpn{o-genki} \jpn{des-u} \jpn{ka.} \\
...
\begin{exe}
    \ex \gll \jpn{Sakai-san} \jpn{ga} \jpn{Suzuki-san} \jpn{ni} \jpn{chizu-o} \jpn{o-kak}i \jpn{shi-mashi-ta.} \\
...
\begin{itemize}
    ...
    \item Morphosyntactic patterns: \jpn[honoring]{o-verb ni naru} and \jpn[humbling]{o-verb suru}.
...
\hline
give to me & \jpn{kureru} & \jpn{kudasaru} \\
give to someone & \jpn{ageru} & \jpn{sashiageru} \\
receive & \jpn{morau} & \jpn{itadaku} \\

\end{tabular}
\end{itemize}
\begin{exe}
    \ex \gll \jpn{Tanaka-san} \jpn{ga} \jpn{imooto} \jpn{ni} \jpn{o-kashi} \jpn{o} \jpn{tsukut-te} \jpn{kure-ta.} \\
        Tanaka-hon subj younger.sister dat hon.sweets acc make:ger give.to.me-past \\
...
\begin{exe}
       \DeclareRobustCommand{\eachwordone}{\japanesefontsf}
       \DeclareRobustCommand{\eachwordtwo}{\textcolor{teal}}
       \ex \gll 聞いて いい ？ \\
       Kii.te ii ? \\
       \trans Ok to ask (a question)?
       \ex \gll 聞きかせて いただける と うれしい の です が 。 \\
...
\ex  \gll ご 協力 の 程 お 願ねがい 申もうし 上あげます 。 \\
...
\begin{itemize}
    \item Malay culture encourages humility (\textit{merendah diri}).
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Agreement: \jpn[yes]{Hai}, \jpn[so it is]{Sou desu ne}, \jpn[wow]{Sugoi}
        \item Surprise: \jpn[really?]{Eeee?}, \jpn[is that true?]{Honto desu ka?}
...
\begin{frame}{Culturally Appropriate Communication}
  ...
  \item We are normally not clearly aware of how different our own
    culture's way of communicating is from another culture's
