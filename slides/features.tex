...
\begin{itemize}
    ...
    \item Very common in English and Thai
      \begin{exe}      
      \ex \eng{a flock of birds}
      \ex \eng{a herd of cows}
      \ex \eng{a mob of protestors}
      \end{exe}
\end{itemize}
\end{frame}
...
\begin{frame}{Classifiers can indirectly count}
  \begin{exe}
    \ex
   \glll 2-\cll{ts\=u}-no denshim\=eru (Japanese)\\
      2-\cll{tong}-ui imayl (Korean) \\
       2-CL.message-of email \\
  \trans 2 \cll{pieces} of email\\
   
  \ex
  \glll 3-\cll{ts\=u}-no tegami (Japanese)\\
      3-\cll{tong}-ui phyenci (Korean)\\
       3-CL.message-of letter\\
 \trans 3 letters           \\%  \com{direct}
 \ex
 \glll  3-\cll{mai}-no tegami \\
       3-\cll{chang}-ui phyenci (Korean)\\
      3-CL.flat-of letter \\
\trans \{a 3 \cll{page} letter/$^*$3 letters\}  \\%\com{indirect}
    \end{exe}
\citep{Bond:1997b}
\end{frame}
...
Continuous   & V-zhe  & 着   & V-jyuh6 & 住 \\
  ...
  Delimitative	& V-yī-V &一 & V-haa5  & 吓 \\
 Habitual	& & & V-hoi1 & 開 \\
\hline
\end{tabular}
...
\begin{exe}
\ex
\gll Tā kāi-\ul{le} mén, nǐ jiu jìn-qu. \\
...
\begin{exe}
\ex
\gll Wòhng síujé góng-\ul{gán} dihnwá. \\
    Wong miss talk-prog telephone \\
\trans Miss Wong is talking on the phone.\\
\end{exe}
\begin{exe}
\ex
\gll Léih hái Hēunggóng jyuh-\ul{gwo} géi loih a? \\
...
\begin{exe}
\ex
\gll Kéuih jouh-\ul{hōi} jūngdím ge. \\
    she work-hab part.time prt \\
\trans ‘She normally works part-time.’ \\
\end{exe}
\begin{exe}
\ex
\gll Kéuih yíhchìhn jā-\ul{hōi} Bēnsí ge. \\
    she before drive-hab Benz prt \\
\trans ‘She used to drive a Mercedes.’ \\
\end{exe}
\end{frame}
...
\begin{itemize}
    ...
    \item \msa[perfective]{Sudah} and \msa[progressive]{sedang} are common markers.
...
\begin{exe}
\ex
\gll Dèèng paj$^3$ talaat$^5$ sùù$^4$ khùang$^1$ maa$^2$ hùan$^2$ lèèw$^4$. \\
...
\begin{exe}
\ex
\gll Khǎw klàp maa {\silipa lɛέw}. \\
    3sg return hither(come) perf \\
\trans ‘She came back already.’ \\
\end{exe}
\begin{exe}
\ex
\gll Khǎw klàp pay  {\silipa lɛέw}. \\
...
\begin{exe}
\ex
\gll Laaw2 nùng1 khaw5 haj5 khòòj5. \\
...
\begin{exe}
\ex
\gll Khan2 haw2 juu1 nam2 mèè1-thaw5. \\
...
\begin{exe}
\ex
\gll Chúng tôi nhắc đến anh luôn. \\
...
\item Some serial verbs are completely syntactic
  ...
  \end{itemize}
\item [!] Arguments can be transferred (in certain cases)
  \begin{itemize}
...
\ul{She} seems happy.
\end{exe}
    \item Distinction of pronouns: \eng{I} vs.\ \eng{me}, \eng{they} vs.\ \eng{them}.
...
\begin{frame}{Topic Prominence: Mandarin}
  \begin{itemize}
    ...
    \begin{exe}
\ex 
    \gll Zhāngsān wǒ yǐjīng jiàn-guo le. \\
...
\section{Sentence Final Particles (SFP)}
...
\begin{tabular}{lll}
  ...
  \hline
  呀 & ā & lively statement, question \\ 
  呀 & áh & seeking confirmation \\ 
  噏 & ak & abrupt disagreement \\ 
  啦 & lā & requesting, seeking agreement \\ 
  囉 & lo & emphasizing current situation \\ 
  咩 & mē & expressing surprise \\
...
\begin{frame}{Mandarin Sentence-Final Particles}
  \begin{itemize}
    ...
    \item Example: \cmn[question]{ma}, \cmn[suggestion]{ba}, \cmn[emphasis]{ne}.
